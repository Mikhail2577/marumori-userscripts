...
(() => {
  ...
  function normalizeSettings(raw = {}) {
    ...
    const legacyTimerSeconds = Number(source.comboTimeout) / 1e3;
    const timerFallback = Number.isFinite(legacyTimerSeconds) ? legacyTimerSeconds : DEFAULT_SETTINGS.timerSeconds;
  ...
  function createHudController({
    ...
    if (!settings2.hudEnabled) hud.classList.add("hidden");
